...
figure
subplot(3,2,2),drawFigure(array4),title('B-A(Base)');
subplot(3,2,4),drawFigure(array5),title('C-A(Base)');
subplot(3,2,1),drawFigure(array1),title('A-B(Base)');
subplot(3,2,6),drawFigure(array6),title('C-B(Base)');
subplot(3,2,3),drawFigure(array2),title('A-C(Base)');
subplot(3,2,5),drawFigure(array3),title('B-C(Base)');
